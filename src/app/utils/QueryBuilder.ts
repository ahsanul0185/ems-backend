...
> {
    ...
    constructor(
        ...
        this.sortBy = config.defaultSortBy || 'created_at';
        ...
        if (config.defaultSelect) {
            this.selectFields = config.defaultSelect;
            this.query.select = config.defaultSelect;
    ...
    sort () : this {
        ...
        const sortOrder = this.queryParams.sortOrder === 'asc' ? 'asc' : this.sortOrder;
