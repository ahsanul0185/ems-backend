...
const hrClockIn = catchAsync(async (req: Request, res: Response) => {
...
const hrClockOut = catchAsync(async (req: Request, res: Response) => {
    const employeeId = req.body?.employee_id;
    if (!employeeId) {
        return sendResponse(res, {
            httpStatusCode: status.BAD_REQUEST,
...
const getAttendanceByEmployee = catchAsync(async (req: Request, res: Response) => {
...
const hrMarkInformed = catchAsync(async (req: Request, res: Response) => {
    const attendanceId = req.params.id as string;
    const hrProfileId = req.user?.hrProfileId as string; // HR user id
...
const hrUpdateRecord = catchAsync(async (req: Request, res: Response) => {
    const attendanceId = req.params.id as string;
...
const getAttendanceDetailsById = catchAsync(async (req: Request, res: Response) => {
    const attendanceId = req.params.id as string;
