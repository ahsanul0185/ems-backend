...
//         req.user = {
//             ...userData,
//             userId: userData.userId || userData.id // Ensure userId is always present
//         };
...
// /**
//  * Middleware that attempts to populate req.user if a valid token is present, 
//  * but does NOT block the request if the user is unauthenticated (guest).
//  */
