...
export const calculateWorkMinutes = (clockIn, clockOut) => {
    const diff = clockOut.getTime() - clockIn.getTime();
    return Math.floor(diff / (1000 * 60)); // convert ms to minutes
};
export const calculateLateMinutes = (clockIn, expectedClockIn) => {
...
export const calculateEarlyLeaveMinutes = (clockOut, expectedClockOut) => {
...
export const getExpectedShiftTimes = (date) => {
